...
<ul class="promotion-group cm-row-item">
    ...
    <li id="container_add_condition_{$prefix_md5}" class="hidden cm-row-item">
        <div class="option">
        <select onchange="Tygh.$.ceAjax('request', '{"promotions.dynamic?zone=`$zone`&promotion_id=`$smarty.request.promotion_id`"|fn_url nofilter}&prefix=' + escape(this.name) + '&condition=' + this.value + '&elm_id=' + this.id, {$ldelim}result_ids: 'container_' + this.id{$rdelim})">
            <option value=""> -- </option>
