...
<ul class="promotion-group clear">
    ...
    <li id="container_add_bonus" class="clear hidden cm-row-item">
        <div class="option">
            <select onchange="Tygh.$.ceAjax('request', fn_url('promotions.dynamic?prefix=' + escape(this.name) + '&bonus=' + this.value + '&elm_id=' + this.id), {$ldelim}result_ids: 'container_' + this.id{$rdelim})">
                <option value=""> -- </option>
