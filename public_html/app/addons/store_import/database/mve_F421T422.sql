...
UPDATE ?:payment_processors SET processor = "skrill_qc.php" WHERE admin_template = "skrill_qc.tpl";
UPDATE ?:payment_processors SET processor = "skrill_ewallet.php" WHERE admin_template = "skrill_ew.tpl";
