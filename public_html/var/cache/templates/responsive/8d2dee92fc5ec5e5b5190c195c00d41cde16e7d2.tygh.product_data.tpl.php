<?php /* Smarty version Smarty-3.1.18, created on 2014-10-16 03:56:52
         compiled from "/srv/www/server.com/public_html/design/themes/responsive/templates/common/product_data.tpl" */ ?>
<?php /*%%SmartyHeaderCode:452981042543f09c48d6079-43508718%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8d2dee92fc5ec5e5b5190c195c00d41cde16e7d2' => 
    array (
      0 => '/srv/www/server.com/public_html/design/themes/responsive/templates/common/product_data.tpl',
      1 => 1413417015,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '452981042543f09c48d6079-43508718',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_543f09c60a99a4_90248099',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_543f09c60a99a4_90248099')) {function content_543f09c60a99a4_90248099($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/srv/www/server.com/public_html/app/functions/smarty_plugins/block.hook.php';
...
" class="product-title"><?php }?><?php echo smarty_modifier_truncate($_smarty_tpl->tpl_vars['product']->value['product'],44,"...",true);?>
...
</span><?php }?><?php } elseif ((($_smarty_tpl->tpl_vars['product']->value['out_of_stock_actions']=="S")&&($_smarty_tpl->tpl_vars['product']->value['tracking']!="O"))) {?><div class="ty-control-group"><label for="sw_product_notify_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_prefix']->value, ENT_QUOTES, 'UTF-8');?>
<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_id']->value, ENT_QUOTES, 'UTF-8');?>
...
<?php if ($_smarty_tpl->tpl_vars['product']->value['feature_comparison']=="Y") {?><?php if ($_smarty_tpl->tpl_vars['separate_buttons']->value) {?></div><div class="ty-add-to-compare"><?php }?><?php echo $_smarty_tpl->getSubTemplate ("buttons/add_to_compare_list.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('product_id'=>$_smarty_tpl->tpl_vars['product']->value['product_id']), 0);?>
...
if (!empty($_capture_buffer)) {
 ...
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
} else $_smarty_tpl->capture_error();?><?php $_smarty_tpl->tpl_vars["capture_buy_now"] = new Smarty_variable("product_buy_now_".((string)$_smarty_tpl->tpl_vars['obj_id']->value), null, 0);?><?php if (trim(Smarty::$_smarty_vars['capture'][$_smarty_tpl->tpl_vars['capture_buy_now']->value])) {?><?php if ($_smarty_tpl->tpl_vars['separate_buttons']->value) {?><div class="ty-add-buttons-wrapper"><?php }?><<?php if ($_smarty_tpl->tpl_vars['separate_buttons']->value) {?>div<?php } else { ?>span<?php }?> id="cart_buttons_block_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_prefix']->value, ENT_QUOTES, 'UTF-8');?>
<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_id']->value, ENT_QUOTES, 'UTF-8');?>
" class="ty-add-to-wish"><?php echo Smarty::$_smarty_vars['capture'][$_smarty_tpl->tpl_vars['capture_buy_now']->value];?>
</<?php if ($_smarty_tpl->tpl_vars['separate_buttons']->value) {?>div<?php } else { ?>span<?php }?>><?php if ($_smarty_tpl->tpl_vars['separate_buttons']->value) {?></div><?php }?><?php }?><?php }?><?php if (($_smarty_tpl->tpl_vars['product']->value['avail_since']>@constant('TIME'))) {?><?php echo $_smarty_tpl->getSubTemplate ("common/coming_soon_notice.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('avail_date'=>$_smarty_tpl->tpl_vars['product']->value['avail_since'],'add_to_cart'=>$_smarty_tpl->tpl_vars['product']->value['out_of_stock_actions']), 0);?>
...
<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_id']->value, ENT_QUOTES, 'UTF-8');?>
"><?php if ($_smarty_tpl->tpl_vars['details_page']->value) {?><?php }?><?php echo $_smarty_tpl->getSubTemplate ("common/price.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array('value'=>$_smarty_tpl->tpl_vars['product']->value['price'],'span_id'=>"discounted_price_".((string)$_smarty_tpl->tpl_vars['obj_prefix']->value).((string)$_smarty_tpl->tpl_vars['obj_id']->value),'class'=>"ty-price-num"), 0);?>
</span>
