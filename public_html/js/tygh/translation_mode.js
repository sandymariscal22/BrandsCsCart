(function(_, $) {
    ...
    function _changeLanguage(lang_code)
    {
        ...
        if (sl.children().length) {
            var jelm = $('a[data-ca-name=' + lang_code +']', sl);
            var old_elm = $('a[data-ca-name=' + old_lang_code +']', sl);
            if (jelm.data('caCountryCode') && old_elm.data('caCountryCode')) {
                if ($('.ty-flag', sl).length) {
                    $('i.ty-flag-' + old_elm.data('caCountryCode'), sl).first().removeClass('ty-flag-' + old_elm.data('caCountryCode')).addClass('ty-flag-' + jelm.data('caCountryCode'));
                } else {
            ...
            $('a.cm-combination', sl).removeClass('open');
        }
        ...
        dispatch: function(e)
        {
            ...
            if (e.type == 'click') {
                if (jelm.closest('.cm-icon-translate').length) {
                    ...
                    _changeLanguage(jelm.data('caName'));
