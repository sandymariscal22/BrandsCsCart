 ...
 */
$config['db_host'] = 'server.com';
$config['db_name'] = 'cscartdb';
$config['db_user'] = 'cscartusr';
$config['db_password'] = 'cscartusr';
...
$config['http_host'] = 'server.com';
$config['http_path'] = '';

// Host and directory where software is installed on secure server
$config['https_host'] = 'server.com';
$config['https_path'] = '';
